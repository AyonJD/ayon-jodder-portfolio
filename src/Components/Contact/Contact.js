                    ...
                    <div className="flex flex-col text-center w-full mb-12">
                        ...
                        <div className=' w-fit mx-auto pb-4'>
                            ...
                            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                                I am a MERN stack web developer from Khulna, Bangladesh. I work as a freelance web developer for clients across the globe with great product delivery and am looking for opportunities to further develop my skills.
                            </p>
                        </div>
                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <div className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                <a className="text-primary">ayonjodder177@gmail.com</a>
