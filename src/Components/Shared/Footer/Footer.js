        ...
        <div className='mt-14'>
            ...
            <footer className="bg-gradient-to-b from-primary to-primary">
                ...
                <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-400 logo uppercase">Ayon Jodder</h2>
                ...
                <div className="py-6 px-4 bg-black md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© 2022 <Link to="https://github.com/AyonJD">Ayon Jodder</Link> | All Rights Reserved.
                    </span>
